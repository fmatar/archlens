...
class DependencyRuleValidatorTest {
    ...
    void testCleanArchitectureViolation() {
        ...
        DependencyEdge legalEdge = new DependencyEdge(
        ...
        DependencyEdge violatingEdge = new DependencyEdge(
                "com.design.domain.Order",
        ...
        assertTrue(validator.evaluate(violatingEdge).isViolating(), "Inner depending on outer is a Clean Architecture violation");

        // implements is polymorphic and never violating
        DependencyEdge implEdge = new DependencyEdge(
                "com.design.adapters.OrderRepositoryImpl",
        ...
        assertFalse(validator.evaluate(implEdge).isViolating(), "Interface implementation is not violating");
    }
}
